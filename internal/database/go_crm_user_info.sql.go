...
func (q *Queries) CreateUserInfo(ctx context.Context, arg CreateUserInfoParams) (GoCrmUserInfo, error) {
...
func (q *Queries) GetUserInfo(ctx context.Context, userID int32) (GoCrmUserInfo, error) {
